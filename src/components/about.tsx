    ...
    return (
        <div id="about" className="min-h-screen text-white">
            ...
            <div className="grid grid-cols-6 grid-rows-7 gap-4  max-w-5xl mx-auto">
                <div className="col-span-2 row-span-3 p-6 rounded-lg bg-[#240B39]">
                ...
                <div className="col-span-4 row-span-3 col-start-3 p-6 rounded-lg bg-[#240B39] ">
                    <div className="flex gap-4 items-center mb-4">
                        <h2 className="text-primary text-2xl">EDUCATION</h2>
                ...
                <div className="col-span-6 row-span-4 row-start-4 p-6 rounded-lg bg-[#240B39]">
                    <h1 className="text-2xl mb-2">Nghiêm Đình Hồng</h1>
                    <h2 className="text-primary">FRESHER FRONT END DEVELOPER</h2>
