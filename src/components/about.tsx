...
const About = () => {
    return (
        <div id="about" className="min-h-screen text-white mb-20">
            <Tittle title="About me" />

            <div className="grid grid-cols-6 grid-rows-7 gap-4  max-w-5xl mx-auto ">
                <div
                    className="col-span-2 row-span-3 p-6 rounded-lg bg-gradient-to-br from-[#131c4a] to-[#0c0117] shadow-xl hover:shadow-emerald-500/10 transition-all duration-300"
                    data-aos="fade-right"
                >
                    <h2 className="text-emerald-400 text-2xl mb-4">CONTACT INFO</h2>
                    <ul className="text-sm space-y-3">
                        <li className="flex gap-2 items-center">
                            <IoCalendar className="shrink-0" color="var(--secondary)" />
                            {aboutMe.dayofbirth}
                        </li>
                        <li className="flex gap-2 items-center">
                            <FaPhone className="shrink-0" color="var(--secondary)" />
                            {aboutMe.phone}
                        </li>
                        <li className="flex gap-2 items-center">
                            <MdEmail className="shrink-0" color="var(--secondary)" />
                            <span className="break-words w-full">{aboutMe.email}</span>
                        </li>

                        <li className="flex gap-2 items-center">
                            <MdLocationOn className="shrink-0" color="var(--secondary)" />
                            {aboutMe.address}
                        </li>
                    </ul>
                </div>
                <div
                    className="col-span-4 row-span-3 col-start-3 p-6 rounded-lg bg-gradient-to-br from-[#131c4a] to-[#0c0117] shadow-xl hover:shadow-emerald-500/10 transition-all duration-300 "
                    data-aos="fade-left"
                >
                    <div className="flex gap-4 items-center mb-4">
                        ...
                        <div className="border-b grow border-emerald-400"></div>
                    </div>

                    <div className="flex gap-3 text-sm">
                        <div className="h-[115px] relative border-r border-emerald-400">
                            <div className="absolute size-4 rounded-full top-0 bg-emerald-400 left-1/2 -translate-x-1/2 shadow-[0_0_10px_#6ee7b7]"></div>
                        </div>
                        <div>
                            <div className="text-xl mb-4">10/2020 - 6/2024</div>
                            <div className="space-y-2">
                                <p>HANOI UNIVERSITY OF INDUSTRY</p>
                                <div className="flex items-center space-x-3">
                                    <FaBookOpen className="w-4 h-4 text-secondary" />
                                    <p className="text-gray-300">Information Technology</p>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <FaTrophy className="w-4 h-4 text-secondary" />
                ...
                <div
                    className="col-span-6 row-span-4 row-start-4 p-6 rounded-lg bg-gradient-to-br from-[#131c4a] to-[#0c0117] shadow-xl hover:shadow-emerald-500/10 transition-all duration-300"
                    data-aos="fade-top"
                    data-aos-delay="100"
                >
