        ...
        <div className="min-h-screen " id="banner">
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-6 mt-40">
                    <h2
                        className="text-2xl tab:text-3xl lap:text-4xl mb-5 text-gray-300 font-semibold"
                        data-aos="fade-down"
                    >
                        I'm Nghiêm Hồng
                    </h2>
                    <h1
                        data-aos="flip-down"
                        data-aos-delay="100"
                        className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text text-3xl mobx:text-4xl tab:text-5xl lap:text-6xl lapx:text-7xl font-bold tab:leading-[3rem] lap:leading-[3.5rem] lapx:leading-[4rem]"
                    >
                ...
                <div className=" flex items-end justify-end">
                    <div className="size-[450px] bg-emerald-300 rounded-lg" data-aos="fade-left"></div>
                </div>
            </div>
        </div>
    );
